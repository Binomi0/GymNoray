...
class App extends Component {
    ...
    render() {
        ...
        let listaOpciones = ['Ladies Noray Inicio', 'Baile Moderno Infantil', 'Cardio Fitness','TRX', 'Gap Streching', 'Body Concept', 'Boot Camp', 'Box Noray', 'FitBall', 'Karate Niños 1', 'Karate Niños 2', 'Karate Adultos' ,'Ninjutsu (Bujinkan)' ,'Salsa Inicio', 'Salsa Medio', 'SpinBike' ,'SpinBike Virtual','Zumba','Bachata Inicio', 'Bachata Medio', 'Bachata Avanzado', 'Coreográfico Estilo Chicas','Flamenco','L-Training','Sevillanas','Step Tono', 'Yoga', 'Pilates', ''],
